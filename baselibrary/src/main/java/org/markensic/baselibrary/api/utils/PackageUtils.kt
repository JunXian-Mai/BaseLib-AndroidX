...
object PackageUtils {
    val applicationInfo = {
        flags: Int ->
        AppGlobal.sApplication.packageManager.getApplicationInfo(AppGlobal.sApplication.packageName, flags)
    }

    val packageInfo = AppGlobal.sApplication.packageManager.getPackageInfo(AppGlobal.sApplication.packageName, 0)
